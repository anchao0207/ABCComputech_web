...
function Switch() {
  ...
  const toogleSwitch = () => setIsOn(!isOn);
  const spring = {
    type: "spring",
    stiffness: 700,
    damping: 30,
  ...
  return (
    <motion.div
      className={`flex w-12 h-7 p-px  border-transparent text-transparent rounded-full cursor-pointer items-center ${
        isOn ? "justify-end bg-blue-600" : "justify-start bg-gray-100"
      }`}
      variants={bgVariants}
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div className="flex justify-center items-center">
          ...
          {/* <label>
              ...
              ></input>
              <div className="relative w-[3.25rem] h-7 p-px bg-gray-100 peer-checked:bg-blue-600 border-transparent text-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 peer-focus:ring-blue-600 peer-disabled:opacity-50 peer-disabled:pointer-events-none peer-checked:bg-none peer-checked:text-blue-600 peer-checked:border-blue-600 peer-focus:checked:border-blue-600 before:inline-block before:size-6 before:bg-blue-600 peer-checked:before:bg-gray-100 before:translate-x-0 peer-checked:before:translate-x-full before:rounded-full before:shadow before:transform before:ring-0 before:transition before:ease-in-out before:duration-200"></div>
            </label> */}
        ...
        <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:items-center">
          {/* <!-- Card --> */}
          <div className="flex flex-col border border-gray-400 text-center rounded-xl p-8 dark:border-neutral-800">
          ...
          {/* <!-- Card --> */}
          <div className="flex flex-col border-2 border-blue-600 text-center shadow-xl rounded-xl p-8 bg-slate-100 dark:border-blue-700">
            <p className="mb-3">
        ...
        <div className="mt-20">
          <div className="text-center ">
            <button
              type="button"
              className="hs-collapse-toggle py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-full border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
          ...
          <div
            ...
            className="hs-collapse hidden w-full overflow-hidden transition-[height] duration-300 mt-12"
          ...
          >
            ...
            <div className="space-y-24 lg:hidden">
              <section>
                ...
                <table className="w-full">
                  <caption className="bg-teal-100 border-t rounded-t-lg border-gray-200 py-3 px-4 text-sm font-bold text-gray-800 text-start dark:bg-neutral-700 dark:border-neutral-700 dark:text-white">
                    Financial data
                  </caption>
                  <thead>
                    <tr>
              ...
              <section>
                ...
                <table className="w-full">
                  <caption className="bg-teal-100 rounded-t-lg border-t border-gray-200 py-3 px-4 text-sm font-bold text-gray-800 text-start dark:bg-neutral-700 dark:border-neutral-700 dark:text-white">
                    Social data
                  </caption>
                  <thead>
                    <tr>
            ...
            <div className="hidden lg:block">
              <table className="w-full h-px">
                ...
                <tbody className="border-t border-gray-200 divide-y divide-gray-200 dark:border-neutral-700 dark:divide-neutral-700 bg-white">
                  <tr>
                    <th
                      className="py-3 ps-6 bg-teal-100 font-bold text-gray-800 text-start dark:bg-neutral-800 dark:text-white"
                      colSpan={5}
                      scope="colgroup"
                    >
                      Financial data
