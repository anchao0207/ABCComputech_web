...
export default function Footer() {
  return (
    <footer className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto border-t border-gray-800 dark:border-neutral-700">
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
        <div className="col-span-full hidden lg:col-span-1 lg:block">
          ...
          <Image
            ...
            priority
          />
          {/* <p className="mt-3 text-sm sm:text-md text-gray-600 dark:text-neutral-400">© 2022 Preline.</p> */}
        </div>

        <div>
          <h4 className="text-lg font-semibold text-gray-900 uppercase dark:text-neutral-100">
            Product
          </h4>
        ...
        <div>
          ...
          <h4 className="mt-7 text-lg font-semibold text-gray-900 uppercase dark:text-neutral-100">
            Industries
          </h4>
      ...
      <div className="pt-5 mt-5 border-t border-gray-800 dark:border-neutral-700">
        <div className="sm:flex sm:justify-between sm:items-center">
          <div className="flex flex-wrap items-center gap-3">
            <div className="hs-dropdown [--placement:top-left] relative inline-flex">
              <button
                ...
                type="button"
                className="hs-dropdown-toggle py-2 px-3 inline-flex items-center gap-x-2 text-md rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 focus:outline-none focus:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-white dark:hover:bg-neutral-800 dark:focus:bg-neutral-800"
                aria-haspopup="menu"
                aria-expanded="false"
                aria-label="Dropdown"
              >
              ...
              >
                <a
                  className="flex items-center gap-x-2 py-2 px-3 rounded-lg text-md text-gray-800 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:hover:text-neutral-300 dark:focus:bg-neutral-700 dark:focus:text-neutral-300"
                  href="#"
                >
                  <svg
          ...
          <div className="flex flex-wrap justify-between items-center gap-3">
            <div className="mt-3 sm:hidden">
              {/* <a className="flex-none font-semibold text-3xl text-black focus:outline-none focus:opacity-80 dark:text-white" href="#" aria-label="Brand">Brand</a> */}
              <Image
                src="/computechicon.png"
                alt="Computech Logo"
                className="w-[200px] lg:w-[200px]"
                ...
                priority
              />
              {/* <p className="mt-1 text-sm sm:text-md text-gray-600 dark:text-neutral-400">© 2022 Preline.</p> */}
            </div>
